...
## Flow Trigger and Execution

The kanzus experiment work by observing events `create` and `modify` in the experimental folder and triggering the correct flows based on 
